...
function Projects() {
    return (
        // <div>
        //     <div style={{width:'315px',float:'left',height:'200px',border:'2px solid gray',margin:'10px 50px 0px 10px'}}></div>
        //     <div style={{width:'315px',float:'left',height:'200px',border:'2px solid gray',margin:'10px 50px 0px 10px'}}></div>
        //     <div style={{width:'315px',float:'left',height:'200px',border:'2px solid gray',margin:'10px 50px 0px 10px'}}></div>
        // </div>
