...
export default function Landing() {
    return (
        <div className="landing-page" style={{ margin: 'auto', width: '80%', minHeight: '100px', overflow: 'hidden', border: '3px solid none', padding: '20px', paddingTop: '7.5rem' }}>
            ...
            <div className="text-center" style={{ margin: '60px 0' }}>
                <a href="https://www.linkedin.com/in/raj---gurung/" target="_blank" rel="noreferrer">
                    {/* LinkedIn */}
