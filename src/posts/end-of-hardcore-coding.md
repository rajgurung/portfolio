...
And here is the part we do not talk about enough. With heavy usage of AI assisted coding, your sharp knife of coding skills will dull. It has to. You cannot sharpen everything at once. As you gain other skills this era demands, something else gives. Are we all ready to accept that coding is no longer a core part of the engineering DNA?
...
In my 14 years of software engineering, we never work like this. We work in a team. We create RFCs to gather feedback. The complex and harder decisions, and even simpler ones, are done with first, second, and third pass checks with Design Reviews. In these days of highly collaborative environments, if we decide to be a SOLO one man Rambo, you are labelled. Gung Ho. Unapproachable. What not...

So why are we still measuring engineering excellence in isolation?

Hardcore coding is not dead. But it is no longer the centre of gravity.

---

*Sources: [ChatGPT Statistics 2025](https://www.index.dev/blog/chatgpt-statistics), [AI Coding Assistant Statistics](https://www.secondtalent.com/resources/ai-coding-assistant-statistics/), [Cursor Statistics](https://taptwicedigital.com/stats/cursor), [Claude Code Stats](https://ppc.land/claude-code-reaches-115-000-developers-processes-195-million-lines-weekly/)*
